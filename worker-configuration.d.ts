/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: da5e042dab86174627ab8a6135f5a0d6)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VALHALLA_GOOGLE_REDIRECT_URI: "http://localhost:8080/oauth2/callback/valhalla/google" | "https://testnet.api.gaia.cc/oauth2/callback/valhalla/google";
		VALHALLA_REDIRECT_TO: "http://localhost:8080" | "https://testnet.valhalla.gaia.cc";
		JWT_SECRET: string;
		IMGBB_API_KEY: string;
		OPENSEA_API_KEY: string;
		GOOGLE_CLIENT_SECRET: string;
		HOLDING_VERIFIER_PUBLIC_KEY: string;
